...
T_z= -p - \frac{L^2_i}{2\mathcal{G}L_p^2} (\partial_z C)^2+ J^{-1}\left(J^2-1\right)-\frac{1}{2v\mathcal{G}}(\partial_z \Phi)^2,\\
...
\partial_z T=0 \Rightarrow \partial_z p = \frac{Q}{\mathcal{G}}\partial_z \Phi\\
T_z= -p -\frac{\epsilon_r}{2\mathcal{G}}(\partial_z \Phi)^2,\\
\beta\partial_t c_s =- \partial_z j_s,\\
\beta\partial_t c_i = -\partial_z j_i,
\end{gather}

So that at first order the fluxes $j_m$ are constant in the layer. In the bath we thus have that:
\begin{gather}
j^{bath}_s = - 2Q \partial_z \Phi \\
j^{bath}_+ = - \frac{D}{D_0} \partial_z c^{bath}_+ - c^{bath}_+\left(\frac{2Q}{c_s}+Q\frac{D}{D_0}+\frac{D}{D_0}\right)\partial_z \Phi \\
j^{bath}_- = - \frac{D}{D_0} \partial_z c^{bath}_- - c^{bath}_-\left(\frac{2Q}{c_s}+Q\frac{D}{D_0}-\frac{D}{D_0}\right)\partial_z \Phi 
\end{gather}
