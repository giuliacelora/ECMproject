...
Unlike for unconstrained swelling, the model $A$ and $B$ are now substantially different. There is no choice of parameter values for which the two are equivalent for any value of $\lambda_1$. 
