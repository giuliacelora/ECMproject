...
\begin{gather}
p^A = \frac{G^A_1+G^A_2}{J_0}(J_0^{2/3}-1) = \frac{24.2 \text{ kPa}}{20.7}(20.7^{2/3}-1) = 7.64 \text{ kPa},\\
p^B = \frac{\kappa}{J_0} = \frac{0.83 \text{ kPa}}{14.8} = 56.08 \text{ Pa}
\end{gather}
...
[NEO-HOOKEAN form IS DERIVED FOR CONSTANT VOLUME DEFORMATION!] 
\newpage
\appendix
